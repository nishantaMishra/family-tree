...
# खदेल -- आयोध्याप्रसाद तथा 

# family data
data = {"name": "खदेल मिश्रा",
        "children": [
                ...
                "children": [
                    ...
                    "children": [
                        ...
                        "children": [
                            ...
                            {"name": "रविशङ्कर मिश्रा(छोटकौ)", "details": "विवाह से पूर्व ही इनकी आकाल मृत्यु हो गयी थी।"}
                        ]
                        },
                        {"name": "उमाशङ्कर मिश्रा",
                        "children": [
                            {"name": "अजयशङ्कर(बबलू) मिश्रा",
                            "children": [
                                {"name": "आशी"},
                                {"name": "अनन्या"},
                                {"name": "नीशू"},
                        ...
                        {"name": "जगिता", "details": "वुष्णुदत्त तिवारी से विवाहित।"} # 
                        #{"name": "४"},
                        #{"name": "५"}
                    ]
                    },
                    {"name": "रमजनिया","details": "रामशिरोमणि से आतरसुई में विवाह हुआ।"}, # 
                    ...
                    "children": [
                        {"name": "अनुराधा तिवारी",
                        "children": [
                            {"name": "प्रभु नारायण तिवारी"},
                            {"name": "अंशु तिवारी", "details": "रवि मिश्रा सङ्ग विवाहित"}
                        ]},
            ...
            },
            {
                ...
                "children": [
                    ...
                    {"name": "दिवाकर मिश्रा", "details": "उमादेवी मिश्रा से विवाहित।",
                    "children": [
                        {"name": "विजय कुमार(बिज्जू) मिश्रा", "details": "सरिता मिश्रा से विवाहित।",
                        "children": [
                            {"name": "शुभम् मिश्रा", "details": "अन्नपूर्णा तिवारी से विवाहित हुआ। अन्नपूर्णा(प्राची) श्री कमलेश तथा श्रीमति ऊषा तिवारी का पुत्री हैं।"}
                        ]},
                        {"name": "२"},
                        {"name": "३"},
                        {"name": "४"},
            ...
            {"name": "भगवानप्रसाद मिश्रा", "details": "आकाशीय बिजली की चपेट में आने से इनकी असमय मृत्यु हो गयी थी।"}
        ]}
...
<script>
    ...
    function getLayoutConfig() {{
        var s = getSize();
        if (s.w < 420) {{
            return {{depthSpacing: 92, nodeRadius: 9, textOffset: 13, textSize: 10.5, fitPaddingX: 24, fitPaddingY: 36}};
        }}
        if (s.w < 768) {{
            return {{depthSpacing: 118, nodeRadius: 10, textOffset: 14, textSize: 11.5, fitPaddingX: 28, fitPaddingY: 42}};
        }}
        return {{depthSpacing: 210, nodeRadius: 12, textOffset: 17, textSize: 13, fitPaddingX: 72, fitPaddingY: 64}};
    }}
    ...
    function applySize() {{
        ...
        var s = getSize();
        treeLayout.size([
            Math.max(120, s.h - margin.top  - margin.bottom),
            Math.max(120, s.w - margin.left - margin.right)
        ]);
    }}

    function fitTreeToView(animate) {{
        var groupNode = gMain.node();
        if (!groupNode) {{
            return;
        }}

        var bbox = groupNode.getBBox();
        ...
        var translateY = (s.h - bbox.height * scale) / 2 - bbox.y * scale;
        var targetTransform = d3.zoomIdentity.translate(translateX, translateY).scale(scale);

        if (animate) {{
            svgEl.transition().duration(320).call(zoom.transform, targetTransform);
        }} else {{
            svgEl.call(zoom.transform, targetTransform);
        }}
    }}

    function scheduleFit(animate, delay) {{
        clearTimeout(fitTimer);
        fitTimer = setTimeout(function() {{
            fitTreeToView(animate);
        }}, delay || 0);
    }}
    ...
    function update(source) {{
        ...
        nodes.forEach(d => {{ d.y = d.depth * layout.depthSpacing; }});
        ...
        nodeEnter.append('text')
            .attr('dy', '.35em')
            .attr('x', layout.textOffset)
            .attr('text-anchor', 'start')
            .style('font-size', layout.textSize + 'px')
            .style('fill', textClr)
            .text(d => d.data.name);
